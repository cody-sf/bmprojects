...
// Layout: landscape 320x240 (the way the cases mount it), with a left
// navigation rail on the main screens instead of the phone's bottom tabs.
constexpr int16_t SCREEN_W   = 320;
constexpr int16_t SCREEN_H   = 240;
constexpr int16_t RAIL_W     = 64;
constexpr int16_t HEADER_H   = 28;
constexpr int16_t CONTENT_Y  = HEADER_H;
constexpr int16_t CONTENT_H  = SCREEN_H - HEADER_H;
