...
#define SERVICE_UUID "4a93f0f8-96ae-4c9a-ba13-6d72aa20a20a"
#define FEATURES_UUID "f2e3acfc-6bf6-4ff8-8be5-4fec7b7d3b55"

// BT Setup
BLEService campService(SERVICE_UUID);
// create switch characteristic and allow remote device to read and write
BLECharacteristic featuresCharacteristic(FEATURES_UUID, BLERead | BLEWrite | BLENotify, 512);

// 5V Setup
#define LED_OUTPUT_PIN_1 27 // Fairy
#define LED_OUTPUT_PIN_2 25 // Fairy
#define LED_OUTPUT_PIN_3 23
#define LED_OUTPUT_PIN_4 22

// 12v Setup
#define LED_OUTPUT_PIN_5 5
#define LED_OUTPUT_PIN_6 19

// Assume 200 LEDS per connection
#define NUM_LEDS 200
...
#define COLOR_ORDER_12 RGB
#define COLOR_ORDER_FAIRY RGB
static Device camp;
...
static CLEDController &led_controller_1 = FastLED.addLeds<WS2812B, LED_OUTPUT_PIN_1, COLOR_ORDER_FAIRY>(leds1, NUM_LEDS);
static CLEDController &led_controller_2 = FastLED.addLeds<WS2812B, LED_OUTPUT_PIN_2, COLOR_ORDER_FAIRY>(leds2, NUM_LEDS);
static CLEDController &led_controller_3 = FastLED.addLeds<WS2812B, LED_OUTPUT_PIN_3, COLOR_ORDER>(leds3, NUM_LEDS);
static CLEDController &led_controller_4 = FastLED.addLeds<WS2812B, LED_OUTPUT_PIN_4, COLOR_ORDER>(leds4, NUM_LEDS);
static CLEDController &led_controller_5 = FastLED.addLeds<WS2812B, LED_OUTPUT_PIN_5, COLOR_ORDER_12>(leds5, NUM_LEDS);
static CLEDController &led_controller_6 = FastLED.addLeds<WS2812B, LED_OUTPUT_PIN_6, COLOR_ORDER_12>(leds6, NUM_LEDS);

static std::vector<CLEDController *> led_controllers = {&led_controller_1, &led_controller_2, &led_controller_3, &led_controller_4, &led_controller_5, &led_controller_6};
...
// Sync Controller
SyncController syncController(light_show, CURRENT_USER, camp);
...
void setup()
{
  ...
  BLE.setLocalName("Camp-XX");
  BLE.setAdvertisedService(campService);
  campService.addCharacteristic(featuresCharacteristic);
  BLE.addService(campService);
